...
public class GroupImageV2 {
    ...
    public static GroupImageV2 create(
        ...
        GroupImageV2 image = new GroupImageV2(group, sortOrder);

        image.addVariant(GroupImageV2Variant.create(
                GroupImageV2VariantType.CARD_440_240, url440x240
        ));
        image.addVariant(GroupImageV2Variant.create(
                GroupImageV2VariantType.THUMBNAIL_100_100, url100x100
        ));
