...
public class GroupLeaveNotificationHandler {
    ...
    public void handle(Long groupId, Long hostUserId, Long leaverUserId) {
        log.info("[NOTI][LEAVE] groupId={}, hostUserId={}, leaverUserId={}", groupId, hostUserId, leaverUserId);
        User actor = userRepository.findById(leaverUserId).orElseThrow(UserNotFoundException::new);
        ...
        Notification saved = notificationRepository.save(
                Notification.createGroupLeaveNotification(receiver, actor, group)
        );
